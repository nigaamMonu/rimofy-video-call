...
export const getFriendRequests = async(req,res)=>{
  try{
    ...
    const acceptedReqs = await FriendRequest.find({recipient: myId, status:'accepted'}).populate('sender','fullName profilePic nativeLanguage learningLanguage location');
